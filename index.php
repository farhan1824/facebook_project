...
<div class="login-container">
        <h2>Login</h2>
        <form action="./login/login_form_handel.php" method="POST">
            ...
            <a href="http://localhost/facebook_like_project/signup/signup.php"><h6>Dont Have Any Account?</h6></a>
        </form>
    </div>
...
// require_once "./login/login_form_handel.php";
